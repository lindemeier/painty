...
template <class T>
inline T Linear(const T& p0, const T& p1, const typename DataType<T>::channel_type t)
{
...
template <class T>
inline T CatmullRom(const T& p_1, const T& p0, const T& p1, const T& p2, typename DataType<T>::channel_type t)
{
  using Float = typename DataType<T>::channel_type;
  ...
  Float b2 =
      static_cast<Float>(0.5) * (static_cast<Float>(3) * t3 - static_cast<Float>(5) * t2 + static_cast<Float>(2));
  Float b3 = static_cast<Float>(0.5) * (static_cast<Float>(-3) * t3 + static_cast<Float>(4) * t2 + t);
...
template <class T>
inline T Cubic(const T& p_1, const T& p0, const T& p1, const T& p2, typename DataType<T>::channel_type t)
{
  using Float = typename DataType<T>::channel_type;
...
template <class T>
inline T CubicDerivativeFirst(const T& p_1, const T& p0, const T& p1, const T& p2, typename DataType<T>::channel_type t)
{
  using Float = typename DataType<T>::channel_type;
...
template <class T>
inline T CubicDerivativeSecond(const T& p_1, const T& p0, const T& p1, const T& p2,
...
public:
  ...
  value_type cubic(value u)
  {
    ...
    value t;
    getControl(u, index, t);
    return Cubic(getIndexClamped(index - 1), getIndexClamped(index), getIndexClamped(index + 1),
  ...
  value_type cubicDerivative(value u, int32_t order)
  {
    ...
    if (order == 2)
    {
      return CubicDerivativeSecond(getIndexClamped(index - 1), getIndexClamped(index), getIndexClamped(index + 1),
                                   getIndexClamped(index + 2), t);
    }
    else
    {
      return CubicDerivativeFirst(getIndexClamped(index - 1), getIndexClamped(index), getIndexClamped(index + 1),
                                  getIndexClamped(index + 2), t);
    }
  }
  ...
  value cubicCurvature(value u)
  {
    ...
    value t;
    getControl(u, index, t);
    return CubicCurvature(getIndexClamped(index - 1), getIndexClamped(index), getIndexClamped(index + 1),
                          getIndexClamped(index + 2), t);
  }
  ...
  value_type catmullRom(value u)
  {
    ...
    value t;
    getControl(u, index, t);
    return CatmullRom(getIndexClamped(index - 1), getIndexClamped(index), getIndexClamped(index + 1),
                      getIndexClamped(index + 2), t);
  }
