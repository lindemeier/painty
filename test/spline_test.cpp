...
TEST(SplineTest, BaseFunctions)
{
  ...
  EXPECT_NEAR(1.6919999999999997, painty::CubicDerivativeFirst(0.0, 2.0, 4.5, 5.9, 0.6), Eps);

  EXPECT_NEAR(1.4399999999999995, painty::CubicDerivativeSecond(0.0, 2.0, 4.5, 5.9, 0.6), Eps);

  std::vector<painty::vec<double, 2> > points = {
    { 0.12, 0.176 }, { 0.42, 0.23 }, { 0.56, 0.32 }, { 0.89, 0.4 }, { 1.12, 0.41 }
  };
  painty::SplineEval<std::vector<painty::vec<double, 2> >::const_iterator> spline(points.cbegin(), points.cend());
